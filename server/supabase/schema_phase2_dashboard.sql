-- ===========================================================================
-- TradeMirror OS — public.client_dashboard(p_client_id uuid)
--
-- Creates ONLY the function the backend calls via
--   supabase.rpc('client_dashboard', { p_client_id })  (client.service.ts)
-- and returns the exact jsonb shape getClientDashboard() consumes.
--
-- Uses the EXISTING schema only — reads public.trades, public.payment_milestones
-- and public.trade_documents (all columns verified present in the live DB). No
-- tables, columns, enums, indexes, or other functions are created or altered.
-- Idempotent: CREATE OR REPLACE re-runs safely.
-- ===========================================================================
